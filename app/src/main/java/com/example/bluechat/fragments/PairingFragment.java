/*
 * ------------------------------------------------------------------------------------------------
 * SUMMARY: PairingFragment.java
 * ------------------------------------------------------------------------------------------------
 * This Fragment is the main entry point of the application. It is responsible for searching for
 * nearby devices, displaying them in a list, and handling the process of initiating a connection.
 *
 * Key Responsibilities:
 * - Starting and stopping the Bluetooth discovery and advertising process.
 * - Displaying found devices (peers) in a ListView for the user to select.
 * - Handling outgoing connection requests when a user taps a device.
 * - Displaying incoming connection requests from other users in a dialog.
 * - Responding to Bluetooth events such as a peer being found, lost, or a connection succeeding/failing.
 * - Managing UI state, such as showing loading indicators, and displaying messages for missing permissions or when no devices are found.
 * ------------------------------------------------------------------------------------------------
 */
package com.bluetooth.bluechat.fragments;
