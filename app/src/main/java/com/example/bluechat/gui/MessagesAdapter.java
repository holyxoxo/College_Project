/*
  ------------------------------------------------------------------------------------------------
  SUMMARY: MessagesAdapter.java
  ------------------------------------------------------------------------------------------------
  This class is a custom adapter for the RecyclerView used in the `ConversationFragment`. Its
  primary role is to manage the list of chat messages and display them correctly on the screen.
  It is one of the most important UI components for the chat functionality.

  Key Responsibilities:
  - Holding the list of `Message` objects.
  - Distinguishing between messages sent by the current user ("MINE") and messages received
  from others ("NON_MINE").
  - Inflating the correct XML layout for each message type (`component_message_send.xml` for
  outgoing and `component_message_received.xml` for incoming).
  - Binding the message text to the appropriate TextView in each message bubble.
  - Providing methods to add new messages to the list and notify the RecyclerView to update.
  - Using the ViewHolder pattern for efficient scrolling and performance.
  ------------------------------------------------------------------------------------------------
 */
